...
ItemTrig.tableActions = {
   ...
   [15] = ActionBase:new( -- Play Sound
      _s(ITEMTRIG_STRING_ACTIONNAME_PLAYSOUND),
      _s(ITEMTRIG_STRING_ACTIONDESC_PLAYSOUND),
      {
         [1] = {
            type = "sound",
            default = "NONE",
      ...
      function(state, context, args)
         --PlaySound(SOUNDS[args[1]])
         ItemTrig.SoundManager:play(SOUNDS[args[1]])
      end
   ),
}
