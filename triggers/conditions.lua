   ...
   [44] = ConditionBase:new( -- Item Type (Detailed)
      ...
      _s(ITEMTRIG_STRING_CONDITIONDESC_SPECIALIZEDITEMTYPE),
      {
         ...
         [2] = {
            ...
            enum = {
               --[SPECIALIZED_ITEMTYPE_ADDITIVE]                   = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_ADDITIVE),
               [SPECIALIZED_ITEMTYPE_ARMOR]                      = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_ARMOR),
               [SPECIALIZED_ITEMTYPE_ARMOR_BOOSTER]              = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_ARMOR_BOOSTER),
               [SPECIALIZED_ITEMTYPE_ARMOR_TRAIT]                = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_ARMOR_TRAIT),
               [SPECIALIZED_ITEMTYPE_AVA_REPAIR]                 = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_AVA_REPAIR),
               [SPECIALIZED_ITEMTYPE_BLACKSMITHING_BOOSTER]      = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_BLACKSMITHING_BOOSTER),
               [SPECIALIZED_ITEMTYPE_BLACKSMITHING_MATERIAL]     = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_BLACKSMITHING_MATERIAL),
               [SPECIALIZED_ITEMTYPE_BLACKSMITHING_RAW_MATERIAL] = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_BLACKSMITHING_RAW_MATERIAL),
               [SPECIALIZED_ITEMTYPE_CLOTHIER_BOOSTER]           = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_CLOTHIER_BOOSTER),
               [SPECIALIZED_ITEMTYPE_CLOTHIER_MATERIAL]          = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_CLOTHIER_MATERIAL),
               [SPECIALIZED_ITEMTYPE_CLOTHIER_RAW_MATERIAL]      = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_CLOTHIER_RAW_MATERIAL),
               [SPECIALIZED_ITEMTYPE_COLLECTIBLE_MONSTER_TROPHY] = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_COLLECTIBLE_MONSTER_TROPHY),
               [SPECIALIZED_ITEMTYPE_COLLECTIBLE_RARE_FISH]      = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_COLLECTIBLE_RARE_FISH),
               [SPECIALIZED_ITEMTYPE_CONTAINER]                  = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_CONTAINER),
               [SPECIALIZED_ITEMTYPE_CONTAINER_EVENT]            = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_CONTAINER_EVENT),
               [SPECIALIZED_ITEMTYPE_CONTAINER_STYLE_PAGE]       = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_CONTAINER_STYLE_PAGE),
               [SPECIALIZED_ITEMTYPE_COSTUME]                    = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_COSTUME),
               [SPECIALIZED_ITEMTYPE_CROWN_ITEM]                 = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_CROWN_ITEM),
               [SPECIALIZED_ITEMTYPE_CROWN_REPAIR]               = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_CROWN_REPAIR),
               [SPECIALIZED_ITEMTYPE_DISGUISE]                   = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_DISGUISE),
               [SPECIALIZED_ITEMTYPE_DRINK_ALCOHOLIC]            = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_DRINK_ALCOHOLIC),
               [SPECIALIZED_ITEMTYPE_DRINK_CORDIAL_TEA]          = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_DRINK_CORDIAL_TEA),
               [SPECIALIZED_ITEMTYPE_DRINK_DISTILLATE]           = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_DRINK_DISTILLATE),
               [SPECIALIZED_ITEMTYPE_DRINK_LIQUEUR]              = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_DRINK_LIQUEUR),
               [SPECIALIZED_ITEMTYPE_DRINK_TEA]                  = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_DRINK_TEA),
               [SPECIALIZED_ITEMTYPE_DRINK_TINCTURE]             = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_DRINK_TINCTURE),
               [SPECIALIZED_ITEMTYPE_DRINK_TONIC]                = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_DRINK_TONIC),
               [SPECIALIZED_ITEMTYPE_DRINK_UNIQUE]               = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_DRINK_UNIQUE),
               [SPECIALIZED_ITEMTYPE_DYE_STAMP]                  = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_DYE_STAMP),
               [SPECIALIZED_ITEMTYPE_ENCHANTING_RUNE_ASPECT]     = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_ENCHANTING_RUNE_ASPECT),
               [SPECIALIZED_ITEMTYPE_ENCHANTING_RUNE_ESSENCE]    = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_ENCHANTING_RUNE_ESSENCE),
               [SPECIALIZED_ITEMTYPE_ENCHANTING_RUNE_POTENCY]    = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_ENCHANTING_RUNE_POTENCY),
               --[SPECIALIZED_ITEMTYPE_ENCHANTMENT_BOOSTER]        = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_ENCHANTMENT_BOOSTER),
               [SPECIALIZED_ITEMTYPE_FISH]                       = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_FISH),
               --[SPECIALIZED_ITEMTYPE_FLAVORING]                  = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_FLAVORING),
               [SPECIALIZED_ITEMTYPE_FOOD_ENTREMET]              = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_FOOD_ENTREMET),
               [SPECIALIZED_ITEMTYPE_FOOD_FRUIT]                 = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_FOOD_FRUIT),
               [SPECIALIZED_ITEMTYPE_FOOD_GOURMET]               = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_FOOD_GOURMET),
               [SPECIALIZED_ITEMTYPE_FOOD_MEAT]                  = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_FOOD_MEAT),
               [SPECIALIZED_ITEMTYPE_FOOD_RAGOUT]                = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_FOOD_RAGOUT),
               [SPECIALIZED_ITEMTYPE_FOOD_SAVOURY]               = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_FOOD_SAVOURY),
               [SPECIALIZED_ITEMTYPE_FOOD_UNIQUE]                = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_FOOD_UNIQUE),
               [SPECIALIZED_ITEMTYPE_FOOD_VEGETABLE]             = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_FOOD_VEGETABLE),
               [SPECIALIZED_ITEMTYPE_FURNISHING_ATTUNABLE_STATION]        = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_FURNISHING_ATTUNABLE_STATION),
               [SPECIALIZED_ITEMTYPE_FURNISHING_CRAFTING_STATION]         = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_FURNISHING_CRAFTING_STATION),
               [SPECIALIZED_ITEMTYPE_FURNISHING_LIGHT]                    = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_FURNISHING_LIGHT),
               [SPECIALIZED_ITEMTYPE_FURNISHING_MATERIAL_ALCHEMY]         = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_FURNISHING_MATERIAL_ALCHEMY),
               [SPECIALIZED_ITEMTYPE_FURNISHING_MATERIAL_BLACKSMITHING]   = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_FURNISHING_MATERIAL_BLACKSMITHING),
               [SPECIALIZED_ITEMTYPE_FURNISHING_MATERIAL_CLOTHIER]        = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_FURNISHING_MATERIAL_CLOTHIER),
               [SPECIALIZED_ITEMTYPE_FURNISHING_MATERIAL_ENCHANTING]      = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_FURNISHING_MATERIAL_ENCHANTING),
               [SPECIALIZED_ITEMTYPE_FURNISHING_MATERIAL_JEWELRYCRAFTING] = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_FURNISHING_MATERIAL_JEWELRYCRAFTING),
               [SPECIALIZED_ITEMTYPE_FURNISHING_MATERIAL_PROVISIONING]    = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_FURNISHING_MATERIAL_PROVISIONING),
               [SPECIALIZED_ITEMTYPE_FURNISHING_MATERIAL_WOODWORKING]     = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_FURNISHING_MATERIAL_WOODWORKING),
               [SPECIALIZED_ITEMTYPE_FURNISHING_ORNAMENTAL]               = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_FURNISHING_ORNAMENTAL),
               [SPECIALIZED_ITEMTYPE_FURNISHING_SEATING]                  = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_FURNISHING_SEATING),
               [SPECIALIZED_ITEMTYPE_FURNISHING_TARGET_DUMMY]             = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_FURNISHING_TARGET_DUMMY),
               [SPECIALIZED_ITEMTYPE_GLYPH_ARMOR]               = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_GLYPH_ARMOR),
               [SPECIALIZED_ITEMTYPE_GLYPH_JEWELRY]             = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_GLYPH_JEWELRY),
               [SPECIALIZED_ITEMTYPE_GLYPH_WEAPON]              = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_GLYPH_WEAPON),
               [SPECIALIZED_ITEMTYPE_HOLIDAY_WRIT]              = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_HOLIDAY_WRIT),
               [SPECIALIZED_ITEMTYPE_INGREDIENT_ALCOHOL]        = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_INGREDIENT_ALCOHOL),
               [SPECIALIZED_ITEMTYPE_INGREDIENT_DRINK_ADDITIVE] = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_INGREDIENT_DRINK_ADDITIVE),
               [SPECIALIZED_ITEMTYPE_INGREDIENT_FOOD_ADDITIVE]  = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_INGREDIENT_FOOD_ADDITIVE),
               [SPECIALIZED_ITEMTYPE_INGREDIENT_FRUIT]          = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_INGREDIENT_FRUIT),
               [SPECIALIZED_ITEMTYPE_INGREDIENT_MEAT]           = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_INGREDIENT_MEAT),
               [SPECIALIZED_ITEMTYPE_INGREDIENT_RARE]           = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_INGREDIENT_RARE),
               [SPECIALIZED_ITEMTYPE_INGREDIENT_TEA]            = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_INGREDIENT_TEA),
               [SPECIALIZED_ITEMTYPE_INGREDIENT_TONIC]          = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_INGREDIENT_TONIC),
               [SPECIALIZED_ITEMTYPE_INGREDIENT_VEGETABLE]      = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_INGREDIENT_VEGETABLE),
               [SPECIALIZED_ITEMTYPE_JEWELRYCRAFTING_BOOSTER]   = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_JEWELRYCRAFTING_BOOSTER),
               [SPECIALIZED_ITEMTYPE_JEWELRYCRAFTING_MATERIAL]  = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_JEWELRYCRAFTING_MATERIAL),
               [SPECIALIZED_ITEMTYPE_JEWELRYCRAFTING_RAW_BOOSTER]  = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_JEWELRYCRAFTING_RAW_BOOSTER),
               [SPECIALIZED_ITEMTYPE_JEWELRYCRAFTING_RAW_MATERIAL] = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_JEWELRYCRAFTING_RAW_MATERIAL),
               [SPECIALIZED_ITEMTYPE_JEWELRY_RAW_TRAIT]          = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_JEWELRY_RAW_TRAIT),
               [SPECIALIZED_ITEMTYPE_JEWELRY_TRAIT]              = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_JEWELRY_TRAIT),
               [SPECIALIZED_ITEMTYPE_LOCKPICK]                   = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_LOCKPICK),
               [SPECIALIZED_ITEMTYPE_LURE]                       = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_LURE),
               [SPECIALIZED_ITEMTYPE_MASTER_WRIT]                = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_MASTER_WRIT),
               [SPECIALIZED_ITEMTYPE_MOUNT]                      = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_MOUNT),
               [SPECIALIZED_ITEMTYPE_NONE]                       = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_NONE),
               --[SPECIALIZED_ITEMTYPE_PLUG]                       = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_PLUG),
               [SPECIALIZED_ITEMTYPE_POISON]                     = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_POISON),
               [SPECIALIZED_ITEMTYPE_POISON_BASE]                = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_POISON_BASE),
               [SPECIALIZED_ITEMTYPE_POTION]                     = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_POTION),
               [SPECIALIZED_ITEMTYPE_POTION_BASE]                = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_POTION_BASE),
               [SPECIALIZED_ITEMTYPE_RACIAL_STYLE_MOTIF_BOOK]    = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_RACIAL_STYLE_MOTIF_BOOK),
               [SPECIALIZED_ITEMTYPE_RACIAL_STYLE_MOTIF_CHAPTER] = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_RACIAL_STYLE_MOTIF_CHAPTER),
               [SPECIALIZED_ITEMTYPE_RAW_MATERIAL]               = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_RAW_MATERIAL),
               [SPECIALIZED_ITEMTYPE_REAGENT_ANIMAL_PART]        = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_REAGENT_ANIMAL_PART),
               [SPECIALIZED_ITEMTYPE_REAGENT_FUNGUS]             = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_REAGENT_FUNGUS),
               [SPECIALIZED_ITEMTYPE_REAGENT_HERB]               = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_REAGENT_HERB),
               [SPECIALIZED_ITEMTYPE_RECALL_STONE_KEEP]          = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_RECALL_STONE_KEEP),
               [SPECIALIZED_ITEMTYPE_RECIPE_ALCHEMY_FORMULA_FURNISHING]        = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_RECIPE_ALCHEMY_FORMULA_FURNISHING),
               [SPECIALIZED_ITEMTYPE_RECIPE_BLACKSMITHING_DIAGRAM_FURNISHING]  = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_RECIPE_BLACKSMITHING_DIAGRAM_FURNISHING),
               [SPECIALIZED_ITEMTYPE_RECIPE_CLOTHIER_PATTERN_FURNISHING]       = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_RECIPE_CLOTHIER_PATTERN_FURNISHING),
               [SPECIALIZED_ITEMTYPE_RECIPE_ENCHANTING_SCHEMATIC_FURNISHING]   = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_RECIPE_ENCHANTING_SCHEMATIC_FURNISHING),
               [SPECIALIZED_ITEMTYPE_RECIPE_JEWELRYCRAFTING_SKETCH_FURNISHING] = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_RECIPE_JEWELRYCRAFTING_SKETCH_FURNISHING),
               [SPECIALIZED_ITEMTYPE_RECIPE_PROVISIONING_DESIGN_FURNISHING]    = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_RECIPE_PROVISIONING_DESIGN_FURNISHING),
               [SPECIALIZED_ITEMTYPE_RECIPE_PROVISIONING_STANDARD_DRINK]       = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_RECIPE_PROVISIONING_STANDARD_DRINK),
               [SPECIALIZED_ITEMTYPE_RECIPE_PROVISIONING_STANDARD_FOOD]        = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_RECIPE_PROVISIONING_STANDARD_FOOD),
               [SPECIALIZED_ITEMTYPE_RECIPE_WOODWORKING_BLUEPRINT_FURNISHING]  = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_RECIPE_WOODWORKING_BLUEPRINT_FURNISHING),
               [SPECIALIZED_ITEMTYPE_SIEGE_BALLISTA]        = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_SIEGE_BALLISTA),
               [SPECIALIZED_ITEMTYPE_SIEGE_BATTLE_STANDARD] = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_SIEGE_BATTLE_STANDARD),
               [SPECIALIZED_ITEMTYPE_SIEGE_CATAPULT]        = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_SIEGE_CATAPULT),
               [SPECIALIZED_ITEMTYPE_SIEGE_GRAVEYARD]       = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_SIEGE_GRAVEYARD),
               [SPECIALIZED_ITEMTYPE_SIEGE_MONSTER]         = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_SIEGE_MONSTER),
               [SPECIALIZED_ITEMTYPE_SIEGE_OIL]             = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_SIEGE_OIL),
               [SPECIALIZED_ITEMTYPE_SIEGE_RAM]             = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_SIEGE_RAM),
               [SPECIALIZED_ITEMTYPE_SIEGE_TREBUCHET]       = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_SIEGE_TREBUCHET),
               [SPECIALIZED_ITEMTYPE_SIEGE_UNIVERSAL]       = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_SIEGE_UNIVERSAL),
               [SPECIALIZED_ITEMTYPE_SOUL_GEM]              = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_SOUL_GEM),
               --[SPECIALIZED_ITEMTYPE_SPELLCRAFTING_TABLET] = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_SPELLCRAFTING_TABLET),
               --[SPECIALIZED_ITEMTYPE_SPICE] = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_SPICE),
               [SPECIALIZED_ITEMTYPE_STYLE_MATERIAL]              = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_STYLE_MATERIAL),
               [SPECIALIZED_ITEMTYPE_TABARD]                      = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_TABARD),
               [SPECIALIZED_ITEMTYPE_TOOL]                        = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_TOOL),
               [SPECIALIZED_ITEMTYPE_TRASH]                       = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_TRASH),
               [SPECIALIZED_ITEMTYPE_TREASURE]                    = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_TREASURE),
               [SPECIALIZED_ITEMTYPE_TROPHY_COLLECTIBLE_FRAGMENT] = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_TROPHY_COLLECTIBLE_FRAGMENT),
               [SPECIALIZED_ITEMTYPE_TROPHY_KEY]                  = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_TROPHY_KEY),
               [SPECIALIZED_ITEMTYPE_TROPHY_KEY_FRAGMENT]         = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_TROPHY_KEY_FRAGMENT),
               [SPECIALIZED_ITEMTYPE_TROPHY_MATERIAL_UPGRADER]    = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_TROPHY_MATERIAL_UPGRADER),
               [SPECIALIZED_ITEMTYPE_TROPHY_MUSEUM_PIECE]         = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_TROPHY_MUSEUM_PIECE),
               [SPECIALIZED_ITEMTYPE_TROPHY_RECIPE_FRAGMENT]      = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_TROPHY_RECIPE_FRAGMENT),
               [SPECIALIZED_ITEMTYPE_TROPHY_RUNEBOX_FRAGMENT]     = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_TROPHY_RUNEBOX_FRAGMENT),
               [SPECIALIZED_ITEMTYPE_TROPHY_SCROLL]               = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_TROPHY_SCROLL),
               [SPECIALIZED_ITEMTYPE_TROPHY_SURVEY_REPORT]        = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_TROPHY_SURVEY_REPORT),
               [SPECIALIZED_ITEMTYPE_TROPHY_TOY]                  = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_TROPHY_TOY),
               [SPECIALIZED_ITEMTYPE_TROPHY_TREASURE_MAP]         = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_TROPHY_TREASURE_MAP),
               [SPECIALIZED_ITEMTYPE_TROPHY_UPGRADE_FRAGMENT]     = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_TROPHY_UPGRADE_FRAGMENT),
               [SPECIALIZED_ITEMTYPE_WEAPON]                      = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_WEAPON),
               [SPECIALIZED_ITEMTYPE_WEAPON_BOOSTER]              = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_WEAPON_BOOSTER),
               [SPECIALIZED_ITEMTYPE_WEAPON_TRAIT]                = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_WEAPON_TRAIT),
               [SPECIALIZED_ITEMTYPE_WOODWORKING_BOOSTER]         = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_WOODWORKING_BOOSTER),
               [SPECIALIZED_ITEMTYPE_WOODWORKING_MATERIAL]        = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_WOODWORKING_MATERIAL),
               [SPECIALIZED_ITEMTYPE_WOODWORKING_RAW_MATERIAL]    = GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_WOODWORKING_RAW_MATERIAL ),
            },
         },
      },
      function(state, context, args)
