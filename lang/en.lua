...
--
ZO_CreateStringId("ITEMTRIG_STRING_CONDITIONNAME_CRAFTINGMATERIALLEVEL", "Crafting Level")
ZO_CreateStringId("ITEMTRIG_STRING_CONDITIONDESC_CRAFTINGMATERIALLEVEL", "This item <<1>> <<2>> level tier.")
ZO_CreateStringId("ITEMTRIG_STRING_OPCODEARG_CRAFTINGMATERIALLEVEL_NO",  "does not belong to")
ZO_CreateStringId("ITEMTRIG_STRING_OPCODEARG_CRAFTINGMATERIALLEVEL_YES", "belongs to")
ZO_CreateStringId("ITEMTRIG_STRING_OPCODEARG_CRAFTINGMATERIALLEVEL_USABLE", "any")
ZO_CreateStringId("ITEMTRIG_STRING_OPCODEARG_CRAFTINGMATERIALLEVEL_PLAYERMAX", "the highest craftable")
ZO_CreateStringId("ITEMTRIG_STRING_OPCODEARG_CRAFTINGMATERIALLEVEL_AFTERPLAYERMAX", "the tier after the highest craftable")
ZO_CreateStringId("ITEMTRIG_STRING_OPCODEARG_CRAFTINGMATERIALLEVEL_MAXTIER", "the highest")
--
--
-- ACTIONS
