...
do
   local list = {
      SPECIALIZED_ITEMTYPE_ADDITIVE, -- unused
      ...
      SPECIALIZED_ITEMTYPE_COSTUME, -- unused
      ...
      SPECIALIZED_ITEMTYPE_FLAVORING, -- unused
      ...
      SPECIALIZED_ITEMTYPE_PLUG, -- unused
      SPECIALIZED_ITEMTYPE_POISON,
      SPECIALIZED_ITEMTYPE_POISON_BASE,
      SPECIALIZED_ITEMTYPE_POTION,
      SPECIALIZED_ITEMTYPE_POTION_BASE,
      SPECIALIZED_ITEMTYPE_RACIAL_STYLE_MOTIF_BOOK, -- any motif book, actually
      SPECIALIZED_ITEMTYPE_RACIAL_STYLE_MOTIF_CHAPTER, -- any motif chapter, actually
      ...
      SPECIALIZED_ITEMTYPE_SPELLCRAFTING_TABLET, -- unused
      SPECIALIZED_ITEMTYPE_SPICE, -- unused
   ...
   for _, v in pairs(list) do
      out[v] = GetString("SI_SPECIALIZEDITEMTYPE", v)
   end
   ItemTrig.gameEnums.specItemTypes = out
end
